...
{
  /* SystemInitialize for SignalConversion generated from: '<S17>/Out1' incorporates:
   *  Outport: '<S17>/Out1'
   */
...
void Sensor_EnabledSubsystem_Disable(B_EnabledSubsystem_Sensors_an_T *localB,
  ...
  *localP)
{
  /* Disable for SignalConversion generated from: '<S17>/Out1' incorporates:
   *  Outport: '<S17>/Out1'
   */
  localB->OutportBufferForOut1 = localP->Out1_Y0;
...
void Sensors_and_actuators_ball_and_plate_output(void)
{
  ...
  if (rtmIsMajorTimeStep(Sensors_and_actuators_ball_a_M)) {
    ...
    denAccum = Sensors_and_actuators_ball_an_B.Sum1;
    denAccum -= Sensors_and_actuators_ball_a_DW.DiscreteTransferFcn_states[0] *
      Sensors_and_actuators_ball_an_P.denc_mi[1];
    denAccum -= Sensors_and_actuators_ball_a_DW.DiscreteTransferFcn_states[1] *
      Sensors_and_actuators_ball_an_P.denc_mi[2];
    denAccum -= Sensors_and_actuators_ball_a_DW.DiscreteTransferFcn_states[2] *
      Sensors_and_actuators_ball_an_P.denc_mi[3];
    denAccum /= Sensors_and_actuators_ball_an_P.denc_mi[0];
    Sensors_and_actuators_ball_a_DW.DiscreteTransferFcn_tmp = denAccum;
    denAccum = Sensors_and_actuators_ball_an_P.numc_mi[0] *
      Sensors_and_actuators_ball_a_DW.DiscreteTransferFcn_tmp;
    denAccum += Sensors_and_actuators_ball_a_DW.DiscreteTransferFcn_states[0] *
    ...
    /* DiscreteTransferFcn: '<Root>/Discrete Transfer Fcn' */
    Sensors_and_actuators_ball_an_B.DiscreteTransferFcn = denAccum;
  }
  ...
  if (Sensors_and_actuators_ball_an_U.CloseLoop_disable >=
    ...
    if (Sensors_and_actuators_ball_an_U.controller_disable >=
      ...
      /* Switch: '<Root>/controller_disable_0' */
      Sensors_and_actuators_ball_an_B.controller_disable_0 =
        Sensors_and_actuators_ball_an_B.DiscreteTransferFcn;
    }
  ...
  denAccum = Sensors_and_actuators_ball_an_B.CloseLoop_disable_0;
...
void Sensors_and_actuators_ball_and_plate_update(void)
{
  if (rtmIsMajorTimeStep(Sensors_and_actuators_ball_a_M)) {
    ...
    Sensors_and_actuators_ball_a_DW.DiscreteTransferFcn_states[2] =
      Sensors_and_actuators_ball_a_DW.DiscreteTransferFcn_states[1];
    Sensors_and_actuators_ball_a_DW.DiscreteTransferFcn_states[1] =
      Sensors_and_actuators_ball_a_DW.DiscreteTransferFcn_states[0];
    Sensors_and_actuators_ball_a_DW.DiscreteTransferFcn_states[0] =
      Sensors_and_actuators_ball_a_DW.DiscreteTransferFcn_tmp;
  }
...
void Sensors_and_actuators_ball_and_plate_initialize(void)
{
  ...
  Sensors_and_actuators_ball_a_DW.DiscreteTransferFcn_states[0] =
    Sensors_and_actuators_ball_an_P.DiscreteTransferFcn_InitialStat;
