...
numObs = 10;  % Number of observations for single target
...
function in = system_reset(in)
    ...
    ball.x0  = -0.195 + 0.39*rand;  % m, initial x distance from plate center
    ball.y0  = -0.195 + 0.39*rand;  % m, initial y distance from plate center
