/************************ dSPACE target specific file *************************
   ...
   Include file .\Sensors_and_actuators_ball_and_plate_2022b_rti1202\Sensors_and_actuators_ball_and_plate_2022b_th.c :

   Task Configuration file for model : Sensors_and_actuators_ball_and_plate_2022b

   RTI1202 7.15 (02-Nov-2020)/2.20
   12-Jun-2023 18:55:00
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\Sensors_and_actuators_ball_and_plate_2022b_rti1202\Sensors_and_actuators_ball_and_plate_2022b_th.c is for ST).
# endif
